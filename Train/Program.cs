...
namespace Train
{
	internal class Program
	{
		static void Main(string[] args)
		{
			...
			Console.WriteLine(" Připoj NV2 k vlaku V1.");
			...
			Train tr2 = new Train(new Locomotive(new Person("Petr", "Svoboda"), new Engine(TypMotoru.parni)), new List<IConnectable> { hv3, hv4, hv5, hv6, hv7 });
			Console.WriteLine("\n Připoj k vlaku V2 vagon NV8.");
			tr2.ConnectWagon(hv8);          // K parní lokomotivě lze připojit max. 5 vagonů.
			Console.WriteLine("\n Odpoj vagon NV8 od vlaku V2.");
			hv8.DisconnectWagon(tr2);       // Tento vagon nelze odpojit, vlak jej neobsahuje.
			Console.WriteLine("\n Odpoj od vlaku V2 vagon NV8 (použije metodu vagonu).");
			tr2.DisconnectWagon(hv8);       // použije metodu vagonu, Tento vagon nelze odpojit, vlak jej neobsahuje.
